const en = {
  ...
  login: {
    ...
    errorMessage: {
      ...
      requiredCode: 'Activation code is required.',
      invalidPassword: 'Invalid password format.',
      repeatPasswordRequired: 'Repeat password is required.',
      passwordMustMatch: 'Passwords must match.',
      resetPassLogin: 'Email and reset key missing from search params!',
    },
    forgotPassword: {
      sending: 'Sending...',
      sendBtn: 'Send Password Reset',
      dialogTitle: 'Check Your Email!',
      subTitle: 'Activation code sent.',
      description:
        'An activation code has been sent to your email. Please enter the code on the next page to reset your password and log in.',
      done: 'Got it',
    },
    resetPassword: {
      saving: 'Saving...',
    ...
    userLogin: 'User must be logged in.',
  ...
  profileBuilder: {
    ...
    steps: {
      ...
      maxInterest: 'Select a maximum of 3 to continue',
      search: 'Search for an attribute',
      noResults: 'No results found',
      details: 'Your Details',
      commaSeparation: 'Separate with commas',
      enterFirstPart: 'You can enter the first part only e.g. EC1',
      addContacts: 'Additional Contacts',
      knownFor: 'What are you known for?',
      typeOfContent: 'Type of content you create',
  ...
  listEmptyMessage: {
    ...
    noSocialData: 'No Social Handles Available',
  ...
  profilePage: {
    ...
    profileTabs: {
      ...
      contacts: {
        ...
        busineeType: 'Business Type',
        deleteAccount: 'Delete Account',
        deletAccountError: 'Error deleting account',
        successAccountDelete: 'Account deleted successfully',
      },
    },
  },
  messageDetail: {
    ...
    sendBtn: 'Send',
    mesageFailed: 'Failed to send message:',
  },
  address: {
    title: 'My Addresses',
    addBtn: 'Add',
  ...
  products: {
    ...
    invalidBrandId: 'Brand Id is invalid.',
  ...
  signUpForm: {
    errMessage: 'An unexpected error occurred during signup',
    emailError: 'Email is undefined',
    unexpectedError: 'An unexpected error occurred',
    incorrectOtp: 'Your activation code is incorrect, please try again',
    loading: 'Loading...',
    ...
    resendOtp: 'Resend activation code',
