          ...
          <Grid container spacing={4}>
            ...
            <Grid item xs={12} md={6}>
              <Typography variant="body1" paragraph>
                ...
                complimentary membership today and discover the brands that resonate with you, while building authentic
                relationships in the process.
              </Typography>

              <Typography variant="body1" paragraph>
                Once approved, your profile will elevate your visibility, increasing your chances of being selected for
                event invitations as well as gifting. Well also then ensure your representatives are notified of
